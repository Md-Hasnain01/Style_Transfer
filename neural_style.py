...
def stylize_onnx_caffe2(content_image, args):
    ...
    prepared_backed = onnx_caffe2.backend.prepare(model, device='CUDA' if args.cuda else 'CPU')
...
def main():
    ...
    train_arg_parser.add_argument("--checkpoint-interval", type=int, default=2000,
                                  help="number of batches after which a checkpoint "
                                       "of the trained model will be created")
